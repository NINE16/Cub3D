...
/*   Updated: 2022/12/21 14:48:26 by nnemeth          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_get_texture(t_recup *recup)
{
	if (!(recup->texture[0].img))
		ft_error2(recup, "Texture NO\n");
	if (!(recup->texture[1].img))
		ft_error2(recup, "Texture SO\n");
	if (!(recup->texture[2].img))
		ft_error2(recup, "Texture WE\n");
	if (!(recup->texture[3].img))
		ft_error2(recup, "Texture EA\n");
